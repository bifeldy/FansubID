  ...
  tabData: any = [
    ...
    // },
    {
      ...
      data: `
        ...
        <ul>
          <li>Untuk lulus <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">N5</a>, perlu mengetahui sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">100</a> kanji dan sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">800</a> kosakata.</li>
          <li>Untuk lulus <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">N4</a>, perlu mengetahui sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">300</a> kanji dan sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">1.500</a> kosakata.</li>
          <li>Untuk lulus <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">N3</a>, perlu mengetahui sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">650</a> kanji dan sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">3.700</a> kosakata.</li>
          <li>Untuk lulus <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">N2</a>, perlu mengetahui sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">1.000</a> kanji dan sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">6.000</a> kosakata.</li>
          <li>Untuk lulus <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">N1</a>, perlu mengetahui sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">2.000</a> kanji dan sekitar <a target="_blank" class="text-{{ gs.isDarkMode ? 'success-dark' : 'success-light' }} text-decoration-none">10.000</a> kosakata.</li>
        </ul>
